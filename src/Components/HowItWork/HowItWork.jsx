  ...
  return (
    <div className="my-8">
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="headingFont text-3xl sm:text-5xl font-extrabold mb-1 tracking-tight">
              How it
              <span className="text-green-600  ml-2">works</span>
            </h2>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-14">
        <Link
          to="/signIn"
          className="relative bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center text-center"
        >
          <img
          ...
          <div className="absolute -top-7 left-1/2 transform -translate-x-1/2  rounded-full bg-green-600 shadow-lg">
