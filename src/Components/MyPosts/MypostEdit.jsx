...
const MypostEdit = () => {
  ...
  return (
    <form
      className="flex flex-col gap-4 bg-white p-8 w-full max-w-xl mx-auto rounded-xl font-sans shadow-2xl border border-green-100 my-5"
    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className="bg-red-600 w-full border-2 border-black rounded-lg focus:outline-none focus:border-green-500 transition duration-150 px-4 "
          type="text"
          required
      ...
      <div className=" gap-4">
        <div className="">
          ...
          <select
            id="Type"
            name="type"
            className="w-full border-2 border-black rounded-lg focus:outline-none focus:border-green-500 transition duration-150 px-4"
            required
